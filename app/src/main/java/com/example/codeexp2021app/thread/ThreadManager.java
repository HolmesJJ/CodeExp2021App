...
public class ThreadManager {
    ...
    private ThreadManager() {
        scheduleExec = new ScheduledThreadPoolExecutor(4, new CustomThreadFactory());
    }

    public static final ThreadManager getThreadPollProxy() {
    ...
    public List<Runnable> shutDownNow() {
        return scheduleExec.shutdownNow();
    }
    ...
    public boolean isShutDown() {
        return scheduleExec.isShutdown();
    }
    ...
    public boolean isTerminated() {
        return scheduleExec.isTerminated();
    }
    ...
    public boolean awaitTermination(long timeout, TimeUnit unit) throws InterruptedException {
        return scheduleExec.awaitTermination(timeout, unit);
    }
    ...
    public <T> Future<T> submit(Callable<T> task) {
        return scheduleExec.submit(task);
    }
    ...
    public <T> Future<T> submit(Runnable task, T result) {
        return scheduleExec.submit(task, result);
    }
    ...
    public <T> List<Future<T>> invokeAll(Collection<? extends Callable<T>> tasks) throws InterruptedException {
        return scheduleExec.invokeAll(tasks);
    }
    ...
    public <T> List<Future<T>> invokeAll(Collection<? extends Callable<T>> tasks, long timeout, TimeUnit unit) throws
        ...
        return scheduleExec.invokeAll(tasks, timeout, unit);
    }
    ...
    public <T> T invokeAny(Collection<? extends Callable<T>> tasks) throws InterruptedException, ExecutionException {
        return scheduleExec.invokeAny(tasks);
    }
    ...
    public <T> T invokeAny(Collection<? extends Callable<T>> tasks, long timeout, TimeUnit unit) throws
        ...
        return scheduleExec.invokeAny(tasks, timeout, unit);
    }
