...
public class FileUtils {
    ...
    // /storage/emulated/0/Android/data/com.example.codeexp2021app/files/
    public static final String SDCARD_PATH = ContextUtils.getContext().getExternalFilesDir(null).getAbsolutePath() + File.separator;
    // /data/user/0/com.example.codeexp2021app/files/
    public static final String DATA_PATH = ContextUtils.getContext().getFilesDir().getAbsolutePath() + File.separator;
    public static final String APP_DIR = SDCARD_PATH + "CodeExp2021App" + File.separator;
    public static final String DATA_APP_DIR = DATA_PATH + "CodeExp2021App" + File.separator;
